...
CREATE INDEX idx_shipments_origin_address_id ON shipments(origin_address_id);
CREATE INDEX idx_shipments_destination_address_id ON shipments(destination_address_id);
